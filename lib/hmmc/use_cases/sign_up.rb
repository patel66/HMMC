module HMMC
  class SignUp < UseCase
    def run(inputs)
      ...
      new_school = HMMC.db.create_school(:school_name => school_name, :street => school_street, :city => school_city, :state => school_state, :user_id => new_user.id, :students => school_students)
